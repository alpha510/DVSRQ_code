...
//	pair<int, int> factors = {1, 1}; 
	...
	StorageServer SS0(serv[0].eRect, serv[0].gridSet);  //定义SERVER_NUM个存储服务器并初始化
...
//	StorageServer SS8(serv[8].eRect, serv[8].gridSet);
	...
	//===============================================================================//
	//--------------------------------范围查询过程-----------------------------------//
	char fname[5][50] = {"NE/NE_rect_testset1.txt", "NE/NE_rect_testset2.txt", "NE/NE_rect_testset3.txt", "NE/NE_rect_testset4.txt", "NE/NE_rect_testset5.txt"};
	char res_name[5][20] = {"NE/res_test1.txt", "NE/res_test2.txt", "NE/res_test3.txt", "NE/res_test4.txt", "NE/res_test5.txt"};

//	char fname[1][50] = {"NE/NE_rect_testset_pre.txt"};
//	char res_name[1][30] = {"NE/res_m_9.txt"};
	FILE *fp;
	for (int i = 0; i < 5; i++)
	{
...
//				SS8.setEmpty();
	...
	//===============================================================================//*/
	/*//-------------------------------点查询-插入过程---------------------------------//
	char fname[50] = "NE/NE_point_testset.txt";
	char rname1[50] = "NE/res_insert.txt";
	FILE *fp;
...
//	//===============================================================================//
//	//-------------------------------点查询-删除过程---------------------------------//
//	char rname2[50] = "NE/delete_res_test.txt";
