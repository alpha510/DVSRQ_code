...
//	{
//		Rectangle r = serv[i].rect;
//		cout << i << ":" << endl;
//		cout << r.minX << ", " << r.maxX << ", " << r.minY << ", " << r.maxY << endl;
//	}
	dataPoints.clear();  //释放dataPoints所占空间 
	float theta = THETA;
...
//	StorageServer SS8(serv[8].eRect, serv[8].gridSet);
	...
	//===============================================================================//*/
	//--------------------------------范围查询过程-----------------------------------//
	char fname[5][50] = {"GA/GA_rect_testset1.txt", "GA/GA_rect_testset2.txt", "GA/GA_rect_testset3.txt", "GA/GA_rect_testset4.txt", "GA/GA_rect_testset5.txt"};
	char res_name[5][20] = {"GA/res_test1.txt", "GA/res_test2.txt", "GA/res_test3.txt", "GA/res_test4.txt", "GA/res_test5.txt"};
//	char fname[1][50] = {"GA/GA_rect_testset_pre.txt"};
//	char res_name[1][20] = {"GA/res_m_6.txt"};
...
//				SS8.setEmpty();
	...
	//===============================================================================//*/
	/*//-------------------------------点查询-插入过程---------------------------------//
	char fname[50] = "GA/GA_point_testset.txt";
	char rname1[50] = "GA/res_insert.txt";
	FILE *fp;
...
//		SS3qthread.join();
		...
		DO.FinalResult = TS.FinalResult;  //DO从TS拿到点查询的结果 
...
//	//===============================================================================//
//	//-------------------------------点查询-删除过程---------------------------------//
//	char rname2[50] = "GA/delete_res_test.txt";
